...
OUTDIR="./souffle-out/profile-interp/$1"
...
$SOUFFLE/souffle --profile=$1-profile-interp --emit-statistics -F $FACTDIR $PROGRAM -D $OUTDIR --jobs=1  --wno=var-appears-once --wno=no-rules-nor-facts
$SOUFFLE/souffle --a=$1-profile-interp -F $FACTDIR $PROGRAM -D $OUTDIR --jobs=1  --wno=var-appears-once --wno=no-rules-nor-facts
