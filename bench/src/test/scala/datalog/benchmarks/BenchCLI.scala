...
import datalog.dsl.*
import datalog.execution.{Backend, CompileSync, ExecutionEngine, JITOptions, NaiveExecutionEngine, SemiNaiveExecutionEngine, SortOrder, StagedExecutionEngine, ir}
...
//  }
  ...
  @Benchmark def runCaracBlockingQuotes(blackhole: Blackhole): Unit = {
    val dotty = staging.Compiler.make(getClass.getClassLoader)
  ...
  @Benchmark def runCaracBC(blackhole: Blackhole): Unit = {
    val dotty = staging.Compiler.make(getClass.getClassLoader)
