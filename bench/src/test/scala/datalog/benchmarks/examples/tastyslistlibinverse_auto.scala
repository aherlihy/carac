...
import test.examples.tastyslistlibinverse_auto.tastyslistlibinverse_auto as tastyslistlibinverse_auto_test
...
class tastyslistlibinverse_auto() extends ExampleBenchmarkGenerator("tastyslistlibinverse_auto") with tastyslistlibinverse_auto_test {
