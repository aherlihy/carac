...
import test.examples.tastyslistlibinverse_bpt_winv.tastyslistlibinverse_bpt_winv as tastyslistlibinverse_bpt_winv_test
...
class tastyslistlibinverse_bpt_winv() extends ExampleBenchmarkGenerator("tastyslistlibinverse_bpt_winv") with tastyslistlibinverse_bpt_winv_test {
