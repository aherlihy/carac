...
import test.examples.fib.{fib_optimized as fib_optimized_test, fib_worst as fib_worst_test}
...
class XXfib_optimized_fuzz1() extends ExampleBenchmarkGenerator(
  "fib"
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "fib"
) with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz3() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz4() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz5() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz7() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz1() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz2() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz3() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz4() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz5() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz7() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz20() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz20() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_worst_fuzz10() extends ExampleBenchmarkGenerator("fib") with fib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXfib_optimized_fuzz10() extends ExampleBenchmarkGenerator("fib") with fib_optimized_test {
