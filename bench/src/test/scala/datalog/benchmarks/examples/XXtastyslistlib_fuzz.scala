...
import test.examples.tastyslistlib.tastyslistlib_optimized as tastyslistlib_optimized_test
import test.examples.tastyslistlib.tastyslistlib_worst as tastyslistlib_worst_test
...
class XXtastyslistlib_optimized_fuzz1() extends ExampleBenchmarkGenerator(
  "tastyslistlib"
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "tastyslistlib"
) with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz3() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz4() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz5() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz7() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz1() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz2() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz3() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz4() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz5() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz7() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz20() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz20() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_worst_fuzz10() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlib_optimized_fuzz10() extends ExampleBenchmarkGenerator("tastyslistlib") with tastyslistlib_optimized_test {
