...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXackermann_worst_fuzz10() extends ExampleBenchmarkGenerator("ackermann") with ackermann_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXackermann_optimized_fuzz10() extends ExampleBenchmarkGenerator("ackermann") with ackermann_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXackermann_worst_fuzz20() extends ExampleBenchmarkGenerator("ackermann") with ackermann_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXackermann_optimized_fuzz20() extends ExampleBenchmarkGenerator("ackermann") with ackermann_optimized_test {
