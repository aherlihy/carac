...
import test.examples.tastypointstofun.{tastypointstofun => tastypointstofun_test}
...
class tastypointstofun() extends ExampleBenchmarkGenerator(
  "tastypointstofun"
) with tastypointstofun_test {
