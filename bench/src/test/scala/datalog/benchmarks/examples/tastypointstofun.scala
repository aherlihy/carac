...
import test.examples.tastypointstofun.tastypointstofun as tastypointstofun_test
...
class tastypointstofun() extends ExampleBenchmarkGenerator("tastypointstofun") with tastypointstofun_test {
