...
import test.examples.tastyslistlibinverse.tastyslistlibinverse_optimized as tastyslistlibinverse_optimized_test
...
class XXtastyslistlibinverse_optimized() extends ExampleBenchmarkGenerator(
