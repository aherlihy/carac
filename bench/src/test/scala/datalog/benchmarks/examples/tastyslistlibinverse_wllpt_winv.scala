...
import test.examples.tastyslistlibinverse_wllpt_winv.tastyslistlibinverse_wllpt_winv as tastyslistlibinverse_wllpt_winv_test
...
class tastyslistlibinverse_wllpt_winv() extends ExampleBenchmarkGenerator("tastyslistlibinverse_wllpt_winv") with tastyslistlibinverse_wllpt_winv_test {
