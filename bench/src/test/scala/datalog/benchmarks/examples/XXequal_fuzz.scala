...
import test.examples.equal.{equal_optimized as equal_optimized_test, equal_worst as equal_worst_test}
...
class XXequal_optimized_fuzz1() extends ExampleBenchmarkGenerator(
  "equal"
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "equal"
) with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz3() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz4() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz5() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz7() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz1() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz2() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz3() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz4() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz5() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz7() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz20() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz20() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_worst_fuzz10() extends ExampleBenchmarkGenerator("equal") with equal_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXequal_optimized_fuzz10() extends ExampleBenchmarkGenerator("equal") with equal_optimized_test {
