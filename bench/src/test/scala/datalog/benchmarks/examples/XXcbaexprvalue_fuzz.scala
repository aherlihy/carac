...
class XXcbaexprvalue_optimized_fuzz1() extends ExampleBenchmarkGenerator(
  "cbaexprvalue"
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "cbaexprvalue"
) with cbaexprvalue_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_optimized_fuzz3() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_optimized_fuzz5() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_worst_fuzz1() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_worst_fuzz2() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_worst_fuzz3() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXcbaexprvalue_worst_fuzz5() extends ExampleBenchmarkGenerator("cbaexprvalue") with cbaexprvalue_worst_test {
