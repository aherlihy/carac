...
import test.examples.tastyslistlibinverse.{tastyslistlibinverse_optimized as tastyslistlibinverse_optimized_test, tastyslistlibinverse_worst as tastyslistlibinverse_worst_test}
...
class XXtastyslistlibinverse_optimized_fuzz1() extends ExampleBenchmarkGenerator(
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "tastyslistlibinverse"
) with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz3() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz4() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz5() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz7() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz1() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz2() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz3() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz4() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz5() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz7() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz20() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz20() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_worst_fuzz10() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXtastyslistlibinverse_optimized_fuzz10() extends ExampleBenchmarkGenerator("tastyslistlibinverse") with tastyslistlibinverse_optimized_test {
