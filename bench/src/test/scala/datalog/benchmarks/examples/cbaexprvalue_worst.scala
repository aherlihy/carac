...
import test.examples.cbaexprvalue.{cbaexprvalue_worst => cbaexprvalue_worst_test}
...
class XXcbaexprvalue_worst() extends ExampleBenchmarkGenerator(
  "cbaexprvalue"
) with cbaexprvalue_worst_test {
