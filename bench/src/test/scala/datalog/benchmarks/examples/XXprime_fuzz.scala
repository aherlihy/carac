...
import test.examples.prime.{prime_optimized as prime_optimized_test, prime_worst as prime_worst_test}
...
class XXprime_optimized_fuzz1() extends ExampleBenchmarkGenerator(
  "prime"
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz2() extends ExampleBenchmarkGenerator(
  "prime"
) with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz3() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz4() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz5() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz7() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz1() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz2() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz3() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz4() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz5() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz7() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz20() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz20() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_worst_fuzz10() extends ExampleBenchmarkGenerator("prime") with prime_worst_test {
...
@State(Scope.Thread)
@BenchmarkMode(Array(Mode.AverageTime))
class XXprime_optimized_fuzz10() extends ExampleBenchmarkGenerator("prime") with prime_optimized_test {
