...
import test.examples.tastyslistlibnegated.{tastyslistlibnegated => tastyslistlibnegated_test}
...
class tastyslistlibnegated() extends ExampleBenchmarkGenerator(
  "tastyslistlibnegated"
) with tastyslistlibnegated_test {
