...
import test.examples.tastyslistlibinverse_autoworstsel.{tastyslistlibinverse_autoworstsel => tastyslistlibinverse_autoworstsel_test}
...
class tastyslistlibinverse_autoworstsel() extends ExampleBenchmarkGenerator(
  "tastyslistlibinverse_autoworstsel"
