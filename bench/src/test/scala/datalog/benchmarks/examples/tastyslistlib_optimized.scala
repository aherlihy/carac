...
import test.examples.tastyslistlib_optimized.tastyslistlib_optimized as tastyslistlib_optimized_test
...
class tastyslistlib_optimized() extends ExampleBenchmarkGenerator("tastyslistlib_optimized") with tastyslistlib_optimized_test {
