...
import test.examples.tastyslistlibmini.tastyslistlibmini as tastyslistlibmini_test
...
class tastyslistlibmini() extends ExampleBenchmarkGenerator("tastyslistlibmini") with tastyslistlibmini_test {
