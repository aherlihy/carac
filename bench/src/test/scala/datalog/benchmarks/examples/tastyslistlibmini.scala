...
import test.examples.tastyslistlibmini.{tastyslistlibmini => tastyslistlibmini_test}
...
class tastyslistlibmini() extends ExampleBenchmarkGenerator(
  "tastyslistlibmini"
) with tastyslistlibmini_test {
