...
import test.examples.tastyslistlibworst.tastyslistlibworst as tastyslistlibworst_test
...
class tastyslistlibworst() extends ExampleBenchmarkGenerator("tastyslistlibworst") with tastyslistlibworst_test {
