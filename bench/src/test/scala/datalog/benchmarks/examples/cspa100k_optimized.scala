...
import test.examples.cspa100k.cspa100k_optimized as cspa100k_optimized_test
...
class cspa100k_optimized() extends ExampleBenchmarkGenerator(
  "cspa100k"
) with cspa100k_optimized_test {
