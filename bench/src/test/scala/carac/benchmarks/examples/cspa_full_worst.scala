...
import test.examples.cspa_full.cspa_full_worst as cspa_full_worst_test
...
class cspa_full_worst() extends ExampleBenchmarkGenerator(
  "cspa_full"
) with cspa_full_worst_test {
