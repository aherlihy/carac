package test.examples.cspa_tiny

import buildinfo.BuildInfo
import datalog.dsl.{Constant, Program}
import test.ExampleTestGenerator

class cspa_tiny_test extends ExampleTestGenerator("cspa_tiny") with cspa_tiny

trait cspa_tiny {
  val factDirectory = s"${BuildInfo.baseDirectory}/src/test/scala/test/examples/cspa_tiny/facts"
