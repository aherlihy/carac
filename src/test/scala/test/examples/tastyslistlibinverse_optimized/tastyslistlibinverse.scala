package test.examples.tastyslistlibinverse_optimized

import datalog.dsl.{Constant, Program}
import test.ExampleTestGenerator

class tastyslistlibinverse_optimized_test extends ExampleTestGenerator("tastyslistlibinverse_optimized") with tastyslistlibinverse_optimized
