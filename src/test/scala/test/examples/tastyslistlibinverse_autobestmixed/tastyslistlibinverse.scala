package test.examples.tastyslistlibinverse_autobestmixed
...
trait tastyslistlibinverse_autobestmixed {
...
//    CallGraph(v12, v9) :- (Reachable(v14), VCall(v5, v13, v12, v14), LookUp(v15, v13, v9), HeapType(v1, v15), VarPointsTo(v5, v1), ThisVar(v9, v10))
    CallGraph(v12, v9) :- (HeapType(v1, v15), LookUp(v15, v13, v9), ThisVar(v9, v10), VCall(v5, v13, v12, v14), Reachable(v14), VarPointsTo(v5, v1))

//    CallGraph(v12, v9) :- (SuperCall(v9, v12, v14), Reachable(v14), ThisVar(v14, v11), VarPointsTo(v11, v1), ThisVar(v9, v10))
    CallGraph(v12, v9) :- (SuperCall(v9, v12, v14), ThisVar(v14, v11), Reachable(v14), ThisVar(v9, v10), VarPointsTo(v11, v1))
//    Equiv(v30, v29) :- (Reachable(v35), StaticCall(v31, v32, v35), InverseFns(v31, v33), StaticCall(v33, v34, v35), ActualReturn(v34, v37), ActualArg(v34, v27, v28, v29), ActualReturn(v32, v30), ActualArg(v32, v25, v26, v38), VarEquiv(v38, v37))
    Equiv(v30, v29) :- (InverseFns(v31, v33), StaticCall(v31, v32, v35), StaticCall(v33, v34, v35), ActualReturn(v34, v37), ActualArg(v34, v27, v28, v29), ActualReturn(v32, v30), ActualArg(v32, v25, v26, v38), VarEquiv(v38, v37), Reachable(v35))
...
//    Reachable(v9) :- (SuperCall(v9, v12, v14), Reachable(v14), ThisVar(v14, v11), VarPointsTo(v11, v1), ThisVar(v9, v10))
    Reachable(v9) :- (SuperCall(v9, v12, v14), ThisVar(v14, v11), VarPointsTo(v11, v1), ThisVar(v9, v10), Reachable(v14))
    ...
    Reachable(v9) :- (HeapType(v1, v15), LookUp(v15, v13, v9), ThisVar(v9, v10), VCall(v5, v13, v12, v14), Reachable(v14), VarPointsTo(v5, v1))

//    VarPointsTo(v10, v1) :- (Reachable(v14), VCall(v5, v13, v12, v14), LookUp(v15, v13, v9), HeapType(v1, v15), VarPointsTo(v5, v1), ThisVar(v9, v10))
    VarPointsTo(v10, v1) :- (HeapType(v1, v15), LookUp(v15, v13, v9), ThisVar(v9, v10), VCall(v5, v13, v12, v14), Reachable(v14), VarPointsTo(v5, v1))
...
//    VarPointsTo(v10, v1) :- (SuperCall(v9, v12, v14), Reachable(v14), ThisVar(v14, v11), VarPointsTo(v11, v1), ThisVar(v9, v10))
    VarPointsTo(v10, v1) :- (SuperCall(v9, v12, v14), ThisVar(v14, v11), Reachable(v14), ThisVar(v9, v10), VarPointsTo(v11, v1))
