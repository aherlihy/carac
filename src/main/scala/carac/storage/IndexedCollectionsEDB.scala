...
import carac.dsl.{Constant, Variable}

import scala.collection.mutable
import IndexedCollectionsCasts.*
import carac.execution.JoinIndexes
import carac.storage.IndexedCollectionsEDB.{allIndexesToString, indexToString}
...
case class IndexedCollectionsEDB(var wrapped: mutable.ArrayBuffer[CollectionsRow],
  ...
  private def createIndexMap(): IndexMap =
    ...
    // carac.benchmarks.examples.cspa10k_optimized.jit_indexed_sel__0_blocking_DELTA_lambda_EOL
    new HashMap()
